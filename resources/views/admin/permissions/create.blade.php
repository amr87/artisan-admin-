            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <label>
                        ...
                        <strong> Create & Attach to an Existing Role </strong>
                    </label>
                </div>
                ...
                <br>
                <button type="submit" class="btn btn-success  btn-block" name="submit"><i class="fa fa-flag"></i> Create Permission</button>
            </div>
            {{ csrf_field() }}
